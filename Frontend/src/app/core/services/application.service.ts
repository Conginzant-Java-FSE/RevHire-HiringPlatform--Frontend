...
export class ApplicationService {
    ...
    applyToJob(jobId: number, coverLetter?: string): Observable<Application> {
        // Backend doesn't currently use coverLetter in the body for applyForJob, 
        // but it's good for forward compatibility if added.
        return this.http.post<Application>(`${this.API_URL}/apply/${jobId}`, { coverLetter });
    }
